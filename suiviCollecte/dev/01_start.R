...
golem::fill_desc(
  ...
  pkg_title = "Suivi Collecte EXF", # The Title of the package containing the App
  pkg_description = "App de suivi de la collecte d'EXF.", # The Description of the package containing the App
